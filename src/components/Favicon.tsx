...
export const Favicon = component$<Props>(({ ...props }) => {
  return (
    <svg
      {...props}
      version="1.0"
    ...
    >
      ...
      >
        <path
          d="M1040 7671 l0 -1801 778 0 c623 0 802 3 904 15 257 30 457 87 663
...
-442 -25 l-363 -5 0 1111 0 1111 324 0 c240 0 345 -4 407 -15z"
        />
        <path
          d="M4949 6028 l0 -3443 -124 250 c-104 212 -207 389 -678 1170 l-555
...
1832 c-4 1007 -7 2839 -7 4070 l0 2238 -425 0 -425 0 -1 -3442z"
        />
        <path
          d="M6133 9408 c13 -35 311 -845 662 -1801 l639 -1737 504 2 504 3 653
...
-62z"
        />
        <path
          d="M1040 3130 l0 -1800 425 0 425 0 0 1800 0 1800 -425 0 -425 0 0
-1800z"
        />
        <path
          d="M6570 3130 l0 -1800 1295 0 1295 0 0 335 0 335 -870 0 -870 0 0 420
